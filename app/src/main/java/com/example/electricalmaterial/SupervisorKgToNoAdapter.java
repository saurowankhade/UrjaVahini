...
public class SupervisorKgToNoAdapter extends RecyclerView.Adapter<KgToNoViewHolder> {
    SupervisorAddMaterial addStock;
    List<KgToNoModel> modelList;

    public SupervisorKgToNoAdapter(SupervisorAddMaterial addStock, List<KgToNoModel> modelList) {
