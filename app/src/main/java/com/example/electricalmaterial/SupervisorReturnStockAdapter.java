...
public class SupervisorReturnStockAdapter extends RecyclerView.Adapter<AddStockViewHolder> {

    SupervisorAddReturnMaterial addStock;
    List<AddStockModel> modelList;

    public SupervisorReturnStockAdapter(SupervisorAddReturnMaterial addStock, List<AddStockModel> modelList) {
