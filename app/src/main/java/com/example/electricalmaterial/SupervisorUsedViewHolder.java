...
public class SupervisorUsedViewHolder extends RecyclerView.ViewHolder {
    TextView mDate,mTeamName,mTender,mConsumerName,mSiteName,mCenter;
    View mView;
    public SupervisorUsedViewHolder(@NonNull View itemView) {
        super(itemView);
        mView = itemView;
    ...
    private SupervisorUsedViewHolder.ClickListener mClickListener;
    public interface ClickListener{
        void onItemClick(View view,int position);
        void onItemLongClick(View view,int position);
    }

    public void setOnClickListener(SupervisorUsedViewHolder.ClickListener clickListener){
