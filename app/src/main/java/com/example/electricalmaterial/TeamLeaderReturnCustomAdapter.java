...
public class TeamLeaderReturnCustomAdapter extends RecyclerView.Adapter<SupervisorReturnViewHolder>{

    TeamLeaderReturnViewData teamLeaderReturnViewData;
    List<SupervisorReturnModel> modelList;

    public TeamLeaderReturnCustomAdapter(TeamLeaderReturnViewData teamLeaderReturnViewData, List<SupervisorReturnModel> modelList) {
    ...
    public SupervisorReturnViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        supervisorViewHolder.setOnClickListener(new SupervisorReturnViewHolder.ClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(teamLeaderReturnViewData,ViewData.class);
                ...
                teamLeaderReturnViewData.startActivity(intent);
            }

            @Override
            public void onItemLongClick(View view, int position) {
                AlertDialog.Builder builder = new AlertDialog.Builder(teamLeaderReturnViewData);
                String [] options = {"View"};
