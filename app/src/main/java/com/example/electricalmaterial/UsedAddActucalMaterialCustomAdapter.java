...
public class UsedAddActucalMaterialCustomAdapter extends RecyclerView.Adapter<RemainingMaterialViewHolder>{

    AddActualMaterial adminViewMaterial;
    List<UsedAddAcutualMaterialModel> modelList;

    public UsedAddActucalMaterialCustomAdapter(AddActualMaterial adminViewMaterial, List<UsedAddAcutualMaterialModel> modelList) {
