...
public class SupervisorUsedData extends AppCompatActivity {

    List<SupervisorUsedModel> modelList = new ArrayList<>();
    ...
    SupervisorUsedCustomAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_supervisor_used_data);
        ...
        centerTIL = findViewById(R.id.centerTILU);
        villageTIL = findViewById(R.id.villageTILU);
        ...
        //Center
        center = findViewById(R.id.centerU);

        //Village
        village = findViewById(R.id.villageU);
        ...
        documentReference.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                mDateFormate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        DatePickerDialog datePickerDialog = new DatePickerDialog(
                                SupervisorUsedData.this, android.R.style.Theme_Material_Light_Dialog_MinWidth,
                ...
                adapterSearch = new ArrayAdapter<String>(SupervisorUsedData.this,R.layout.support_simple_spinner_dropdown_item,item);
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        switch (n) {
                            ...
                            case "Team Name":
                                ...
                                adapterTeam = new ArrayAdapter<String>(SupervisorUsedData.this, R.layout.support_simple_spinner_dropdown_item, spinnerDataList);
                            ...
                            case "Tender":
                                ...
                                adapterTender = new ArrayAdapter<String>(SupervisorUsedData.this, R.layout.support_simple_spinner_dropdown_item, spinnerDataListTender);
                            ...
                            case "Center":
                                ...
                                adapterCenter = new ArrayAdapter<String>(SupervisorUsedData.this, R.layout.support_simple_spinner_dropdown_item, spinnerDataListCenter);
                            ...
                            case "Village":
                                ...
                                adapterVillage = new ArrayAdapter<String>(SupervisorUsedData.this, R.layout.support_simple_spinner_dropdown_item, spinnerDataListVillage);
...
//                return false;
    ...
    private void searchVillage(String cmp, String villageS) {
        ...
        pd.show();
        fStore.collection(cmp+" RemainingMaterial").whereEqualTo("Village",villageS)
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        for (DocumentSnapshot doc : queryDocumentSnapshots){
                            SupervisorUsedModel model = new SupervisorUsedModel(
                                    doc.getString("id"),
                                    doc.getString("Date"),
                        ...
                        adapter = new SupervisorUsedCustomAdapter(SupervisorUsedData.this,modelList);
    ...
    private void searchCenter(String cmp, String centerS) {
        pd.setTitle("Searching...");
        pd.show();
        fStore.collection(cmp+" RemainingMaterial").whereEqualTo("Center",centerS)
                .orderBy("Date", Query.Direction.DESCENDING)
                .get()
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    @Override
...
//                return false;
    ...
    private void searchDate(String cmp, String date) {
        ...
        pd.setTitle("Searching...");
        pd.show();
        fStore.collection(cmp+" RemainingMaterial").whereEqualTo("Date",date.toLowerCase())
                .get()
