...
public class SupervisorReturnCustomAdapter extends RecyclerView.Adapter<SupervisorReturnViewHolder>{

    SupervisorReturnViewMaterial supervisorViewMaterial;
    TeamLeaderReturnViewData teamLeaderReturnViewData;
    List<SupervisorReturnModel> modelList;

    int a;

    public SupervisorReturnCustomAdapter(SupervisorReturnViewMaterial supervisorViewMaterial, List<SupervisorReturnModel> modelList) {
        this.supervisorViewMaterial = supervisorViewMaterial;
        this.modelList = modelList;
    }

    public SupervisorReturnCustomAdapter(TeamLeaderReturnViewData teamLeaderReturnViewData, List<SupervisorReturnModel> modelList,int a) {
        this.teamLeaderReturnViewData = teamLeaderReturnViewData;
        this.modelList = modelList;
        this.a=a;
    }
    ...
    @NonNull
    @Override
    public SupervisorReturnViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.admin_model,parent,false);
        SupervisorReturnViewHolder supervisorViewHolder = new SupervisorReturnViewHolder(itemView);
        supervisorViewHolder.setOnClickListener(new SupervisorReturnViewHolder.ClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(supervisorViewMaterial,ViewData.class);
                ...
                supervisorViewMaterial.startActivity(intent);
            }

            @Override
            public void onItemLongClick(View view, int position) {
                AlertDialog.Builder builder = new AlertDialog.Builder(supervisorViewMaterial);
                ...
                builder.setItems(options, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (which==1){
                            ...
                            Intent intent = new Intent(supervisorViewMaterial,SupervisorAddReturnMaterial.class);
                            intent.putExtra("Id",id);
                            intent.putExtra("Date",date);
                            intent.putExtra("Work","Return");
                            intent.putExtra("TeamName",teamName);
                            intent.putExtra("Line",line);
                            intent.putExtra("Tender",tender);
                            intent.putExtra("Driver Name",driverName);
    ...
    @Override
    public void onBindViewHolder(@NonNull SupervisorReturnViewHolder viewHolder, int i) {
