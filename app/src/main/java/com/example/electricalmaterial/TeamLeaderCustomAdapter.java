...
public class TeamLeaderCustomAdapter extends RecyclerView.Adapter<TeamLeaderViewHolder>{
    TeamLeaderViewData supervisorViewMaterial;
    List<TeamLeaderModel> modelList;

    public TeamLeaderCustomAdapter(TeamLeaderViewData supervisorViewMaterial, List<TeamLeaderModel> modelList) {
    ...
    @NonNull
    @Override
    public TeamLeaderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.admin_model,parent,false);
        TeamLeaderViewHolder supervisorViewHolder = new TeamLeaderViewHolder(itemView);
        supervisorViewHolder.setOnClickListener(new TeamLeaderViewHolder.ClickListener() {
            @Override
    ...
    @Override
    public void onBindViewHolder(@NonNull TeamLeaderViewHolder viewHolder, int i) {
