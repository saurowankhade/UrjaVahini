...
public class TotalMaterialAdapter extends RecyclerView.Adapter<RemainingMaterialViewHolder>{

    ViewTotalMaterialTaken adminViewMaterial;
    List<BalanceMaterialModel> modelList;

    public TotalMaterialAdapter(ViewTotalMaterialTaken viewTotalMaterialTaken, List<BalanceMaterialModel> modelList) {
        this.adminViewMaterial = viewTotalMaterialTaken;
    ...
    public RemainingMaterialViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        adminViewHolder.setOnClickListener(new RemainingMaterialViewHolder.ClickListener() {
            ...
            public void onItemLongClick(View view, int position) {
                ...
                String [] options = {"View","Add Actual Material"};
                ...
                builder.setItems(options, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (which==1){
                            ...
                            Intent intent = new Intent(adminViewMaterial, AddActualMaterial.class);
                            intent.putExtra("Id",id);
                            intent.putExtra("Date",date);
                            intent.putExtra("TeamName",teamName);
                            intent.putExtra("Line",line);
