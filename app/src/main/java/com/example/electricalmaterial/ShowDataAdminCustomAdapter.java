...
public class ShowDataAdminCustomAdapter extends RecyclerView.Adapter<AdminViewHolder> {
    ...
    AddMaterial adminViewMaterial;
    List<AdminModel> modelList;

    public ShowDataAdminCustomAdapter(AddMaterial adminViewMaterial, List<AdminModel> modelList) {
            ...
            public void onItemLongClick(View view, int position) {
                ...
                builder.setItems(options, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (which==2){
                            Intent intent = new Intent(adminViewMaterial,AddReturnMaterial.class);
                            intent.putExtra("Id",id);
