...
public class AdminReturnCustomAdapter extends RecyclerView.Adapter<AdminReturnViewHolder> {

    ViewReturnMaterial viewReturnMaterial;
    List<AdminReturnModel> modelList;

    public AdminReturnCustomAdapter(ViewReturnMaterial viewReturnMaterial, List<AdminReturnModel> modelList) {
    ...
    @NonNull
    @Override
    public AdminReturnViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.admin_model,parent,false);
        AdminReturnViewHolder adminReturnViewHolder = new AdminReturnViewHolder(itemView);
        adminReturnViewHolder.setOnClickListener(new AdminReturnViewHolder.ClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(viewReturnMaterial,ViewData.class);
                ...
                viewReturnMaterial.startActivity(intent);
            }

            @Override
            public void onItemLongClick(View view, int position) {
                AlertDialog.Builder builder = new AlertDialog.Builder(viewReturnMaterial);
                ...
                builder.setItems(options, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (which==0){
                            ...
                            Intent intent = new Intent(viewReturnMaterial,AddReturnMaterial.class);
                            intent.putExtra("Id",id);
        ...
        return adminReturnViewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull AdminReturnViewHolder viewHolder, int i) {
