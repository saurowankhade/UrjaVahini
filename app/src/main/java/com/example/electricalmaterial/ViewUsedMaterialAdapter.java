...
public class ViewUsedMaterialAdapter extends RecyclerView.Adapter<ViewBalanceMaterialDataViewHolder> {

    ViewUsedData addStock;
    List<AddTotalMaterialTakenModel> modelList;

    public ViewUsedMaterialAdapter(ViewUsedData addStock, List<AddTotalMaterialTakenModel> modelList) {
