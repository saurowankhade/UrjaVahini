...
public class SupervisorUsedCustomAdapter extends RecyclerView.Adapter<SupervisorUsedViewHolder>{

    SupervisorUsedData adminViewMaterial;
    List<SupervisorUsedModel> modelList;

    public SupervisorUsedCustomAdapter(SupervisorUsedData adminViewMaterial, List<SupervisorUsedModel> modelList) {
    ...
    @NonNull
    @Override
    public SupervisorUsedViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.admin_model,parent,false);
        SupervisorUsedViewHolder adminViewHolder = new SupervisorUsedViewHolder(itemView);
        adminViewHolder.setOnClickListener(new SupervisorUsedViewHolder.ClickListener() {
            @Override
    ...
    @Override
    public void onBindViewHolder(@NonNull SupervisorUsedViewHolder viewHolder, int i) {
