...
public class AddSurveyAdapter extends RecyclerView.Adapter<AddSurveyHolder>{

    Survey survey;
    List<AddSurveyModel> modelList;

    public AddSurveyAdapter(Survey survey, List<AddSurveyModel> modelList) {
        this.survey = survey;
    ...
    @NonNull
    @Override
    public AddSurveyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.add_survey_model,parent,false);
        AddSurveyHolder adminViewHolder = new AddSurveyHolder(itemView);
        adminViewHolder.setOnClickListener(new AddSurveyHolder.ClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                ...
                String unit2 = modelList.get(position).getUnit2();
                ...
                String surveyor = modelList.get(position).getSurveyor();
                String lineman = modelList.get(position).getLineMan();
                ...
                Intent intent = new Intent(survey,ViewSurvey.class);
                ...
                intent.putExtra("Surveyor Name",surveyor);
                intent.putExtra("lineman",lineman);
            ...
            public void onItemLongClick(View view, int position) {
                AlertDialog.Builder builder = new AlertDialog.Builder(survey);
                ...
                builder.setItems(options, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (which==1){
                            Intent intent = new Intent(survey,AddSurvey.class);
                            intent.putExtra("Id",id);
                            intent.putExtra("Date",date);
                            intent.putExtra("Line",line);
                            intent.putExtra("Tender",tender);
                        ...
                        if (which==2){
                            ...
                            builder.setItems(options, new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    if (which==0){
                                        String not = "Cancel";
                                        Toast.makeText(survey, not.toUpperCase(), Toast.LENGTH_SHORT).show();
                                    }
                                    else {
                                        survey.deleteData(position);
                                    }
                                }
                            }).create().show();
    ...
    @Override
    public void onBindViewHolder(@NonNull AddSurveyHolder viewHolder, int i) {

        viewHolder.mDate.setText(modelList.get(i).getDate());
        viewHolder.mSurveyorName.setText(modelList.get(i).getSurveyor());
