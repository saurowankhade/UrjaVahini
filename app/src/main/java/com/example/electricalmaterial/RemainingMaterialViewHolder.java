...
public class RemainingMaterialViewHolder extends RecyclerView.ViewHolder {
    ...
    private RemainingMaterialViewHolder.ClickListener mClickListener;
    public interface ClickListener{
        void onItemClick(View view,int position);
        void onItemLongClick(View view,int position);
    }

    public void setOnClickListener(RemainingMaterialViewHolder.ClickListener clickListener){
