...
public class ViewSurveyMaterialList extends AppCompatActivity {
    //Authorization
    FirebaseAuth mAuth;
    ...
    TextView material,unit,quantity;
    String materialS,unitS,quantityS;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_survey_material_list);
        ...
        documentReference.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                if (bundle!=null){
                    materialS = bundle.getString("Material");
                    unitS = bundle.getString("Unit");
                    quantityS = bundle.getString("Quantity");
                    material.setText(materialS);
                    unit.setText(unitS);
                    quantity.setText(quantityS);
                    click(cmp, materialS, unitS, quantityS);
                }
