...
public class AdminStockAdapter extends RecyclerView.Adapter<AddStockViewHolder> {

    AddMaterial addStock;
    List<AddStockModel> modelList;

    public AdminStockAdapter(AddMaterial addStock, List<AddStockModel> modelList) {
