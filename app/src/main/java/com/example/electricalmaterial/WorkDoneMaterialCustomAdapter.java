...
public class WorkDoneMaterialCustomAdapter extends RecyclerView.Adapter<MaterialViewHolder>{

    ViewWorkDone adminViewMaterial;
    List<MaterialModel> modelList;

    public WorkDoneMaterialCustomAdapter(ViewWorkDone adminViewMaterial, List<MaterialModel> modelList) {
