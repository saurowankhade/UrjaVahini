...
public class AdminReturnStockAdapter extends RecyclerView.Adapter<AddStockViewHolder> {

    AddReturnMaterial addStock;
    List<AddStockModel> modelList;

    public AdminReturnStockAdapter(AddReturnMaterial addStock, List<AddStockModel> modelList) {
