...
public class SupervisorReturnKgToNoAdapter extends RecyclerView.Adapter<KgToNoViewHolder> {
    SupervisorAddReturnMaterial addStock;
    List<KgToNoModel> modelList;

    public SupervisorReturnKgToNoAdapter(SupervisorAddReturnMaterial addStock, List<KgToNoModel> modelList) {
