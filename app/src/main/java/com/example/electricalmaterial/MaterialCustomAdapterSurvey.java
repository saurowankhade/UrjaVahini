...
public class MaterialCustomAdapterSurvey extends RecyclerView.Adapter<MaterialViewHolder>{

    Survey adminViewMaterial;
    List<MaterialModel> modelList;

    public MaterialCustomAdapterSurvey(Survey adminViewMaterial, List<MaterialModel> modelList) {
