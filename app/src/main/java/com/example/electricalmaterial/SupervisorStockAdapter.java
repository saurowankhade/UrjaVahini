...
public class SupervisorStockAdapter extends RecyclerView.Adapter<AddStockViewHolder> {

    SupervisorAddMaterial addStock;
    List<AddStockModel> modelList;

    public SupervisorStockAdapter(SupervisorAddMaterial addStock, List<AddStockModel> modelList) {
