...
public class SupervisorViewMaterial extends AppCompatActivity {
    ...
    SupervisorCustomAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_supervisor_view_material);
        ...
        selectSearch = findViewById(R.id.selectSearch1);
        ...
        documentReference.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                mDateFormate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        DatePickerDialog datePickerDialog = new DatePickerDialog(
                                SupervisorViewMaterial.this, android.R.style.Theme_Material_Light_Dialog_MinWidth,
                ...
                adapterSearch = new ArrayAdapter<String>(getApplicationContext(),androidx.constraintlayout.widget.R.layout.support_simple_spinner_dropdown_item,item);
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        switch (n) {
                            ...
                            case "Team Name":
                                ...
                                adapterTeam = new ArrayAdapter<String>(SupervisorViewMaterial.this,androidx.constraintlayout.widget.R.layout.support_simple_spinner_dropdown_item, spinnerDataList);
                            ...
                            case "Tender":
                                ...
                                adapterTender = new ArrayAdapter<String>(SupervisorViewMaterial.this, androidx.constraintlayout.widget.R.layout.support_simple_spinner_dropdown_item, spinnerDataListTender);
                            ...
                            case "Center":
                                ...
                                adapterCenter = new ArrayAdapter<String>(SupervisorViewMaterial.this, androidx.constraintlayout.widget.R.layout.support_simple_spinner_dropdown_item, spinnerDataListCenter);
                            ...
                            case "Village":
                                ...
                                adapterVillage = new ArrayAdapter<String>(SupervisorViewMaterial.this, androidx.constraintlayout.widget.R.layout.support_simple_spinner_dropdown_item, spinnerDataListVillage);
    ...
    private void searchCenter(String cmp, String center) {
        ...
        pd.show();
        fStore.collection(cmp+" AddData").whereEqualTo("Center",center)
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        adapter = new SupervisorCustomAdapter(SupervisorViewMaterial.this,modelList);
    ...
    private void searchVillage(String cmp, String village) {
        pd.setTitle("Searching...");
        pd.show();
        fStore.collection(cmp+" AddData").whereEqualTo("Village",village)
                .orderBy("Date", Query.Direction.DESCENDING)
                .get()
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    @Override
