...
public class AddActualTotalMaterialTakenAdapter extends RecyclerView.Adapter<AddStockViewHolder> {

    AddActualMaterial addStock;
    List<AddTotalMaterialTakenModel> modelList;

    public AddActualTotalMaterialTakenAdapter(AddActualMaterial addStock, List<AddTotalMaterialTakenModel> modelList) {
