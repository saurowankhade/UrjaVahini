...
public class SupervisorCustomAdapter extends RecyclerView.Adapter<SupervisorViewHolder>{

    SupervisorViewMaterial supervisorViewMaterial;
    List<SupervisorModel> modelList;

    public SupervisorCustomAdapter(SupervisorViewMaterial supervisorViewMaterial, List<SupervisorModel> modelList) {
    ...
    public SupervisorViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        SupervisorViewHolder supervisorViewHolder = new SupervisorViewHolder(itemView);
        supervisorViewHolder.setOnClickListener(new SupervisorViewHolder.ClickListener() {
            @Override
            ...
            public void onItemLongClick(View view, int position) {
                ...
                String [] options = {"View","Update","Return Material"};
                ...
                builder.setItems(options, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (which==0){
                            ...
                            Intent intent = new Intent(supervisorViewMaterial,SupervisorAddMaterial.class);
                                intent.putExtra("Id",id);
                                intent.putExtra("Date",date);
                                intent.putExtra("TeamName",teamName);
                                intent.putExtra("Line",line);
    ...
    @Override
    public void onBindViewHolder(@NonNull SupervisorViewHolder viewHolder, int i) {
