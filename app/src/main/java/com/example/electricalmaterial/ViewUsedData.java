...
public class ViewUsedData extends AppCompatActivity {
    //authorization
    FirebaseAuth mAuth;
    ...
    TextView date,teamName,consumerName,siteName,materialReceiverName,center,village;
    String id,dateS,teamNameS,consumerNameS,siteNameS,materialReceiverNameS,centerS,villageS;
    ...
    ViewUsedMaterialAdapter adapterStockTMT;

    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_used_data);
        ...
        layoutManagerTMT = new LinearLayoutManager(ViewUsedData.this);
    ...
    private void showTotalMaterialTaken(String cmp, String consumerName) {
        ...
        fStore.collection(cmp+" "+consumerName).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                adapterStockTMT = new ViewUsedMaterialAdapter(ViewUsedData.this,modelListTMT);
                recyclerViewTMT.setAdapter(adapterStockTMT);
            }}).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ViewUsedData.this, "Failed "+e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
