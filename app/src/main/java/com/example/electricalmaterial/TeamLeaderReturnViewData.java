...
public class TeamLeaderReturnViewData extends AppCompatActivity {
    ...
    TeamLeaderReturnCustomAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_team_leader_return_view_data);
                ...
                mDateFormate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        DatePickerDialog datePickerDialog = new DatePickerDialog(
                                TeamLeaderReturnViewData.this, android.R.style.Theme_Material_Light_Dialog_MinWidth,
        ...
        fStore.collection(cmp+" AddReturnData").whereEqualTo("Village",villageS)
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        adapter = new TeamLeaderReturnCustomAdapter(TeamLeaderReturnViewData.this,modelList);
