...
public class SupervisorReturnViewMaterial extends AppCompatActivity {

    List<SupervisorReturnModel> modelList = new ArrayList<>();
    ...
    SupervisorReturnCustomAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_supervisor_return_view_material);
        ...
        //Center
        center = findViewById(R.id.centerSRV);

        //Village
        village = findViewById(R.id.villageSRV);
        ...
        documentReference.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                mDateFormate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        DatePickerDialog datePickerDialog = new DatePickerDialog(
                                SupervisorReturnViewMaterial.this, android.R.style.Theme_Material_Light_Dialog_MinWidth,
                ...
                adapterSearch = new ArrayAdapter<String>(getApplicationContext(),R.layout.support_simple_spinner_dropdown_item,item);
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        switch (n) {
                            ...
                            case "Team Name":
                                ...
                                adapterTeam = new ArrayAdapter<String>(getApplicationContext(), R.layout.support_simple_spinner_dropdown_item, spinnerDataList);
                            ...
                            case "Tender":
                                ...
                                adapterTender = new ArrayAdapter<String>(getApplicationContext(), R.layout.support_simple_spinner_dropdown_item, spinnerDataListTender);
                            ...
                            case "Center":
                                ...
                                adapterCenter = new ArrayAdapter<String>(getApplicationContext(), R.layout.support_simple_spinner_dropdown_item, spinnerDataListCenter);
                            ...
                            case "Village":
                                ...
                                adapterVillage = new ArrayAdapter<String>(getApplicationContext(), R.layout.support_simple_spinner_dropdown_item, spinnerDataListVillage);
...
//                return false;
    ...
    private void searchVillage(String cmp, String villageS) {
        ...
        pd.show();
        fStore.collection(cmp+" AddReturnData").whereEqualTo("Village",villageS)
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        for (DocumentSnapshot doc : queryDocumentSnapshots){
                            SupervisorReturnModel model = new SupervisorReturnModel(
                                    doc.getString("id"),
                                    doc.getString("Date"),
                        ...
                        adapter = new SupervisorReturnCustomAdapter(SupervisorReturnViewMaterial.this,modelList);
    ...
    private void searchCenter(String cmp, String centerS) {
        pd.setTitle("Searching...");
        pd.show();
        fStore.collection(cmp+" AddReturnData").whereEqualTo("Center",centerS)
                .orderBy("Date", Query.Direction.DESCENDING)
                .get()
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    @Override
    ...
    private void searchTeamName(String cmp, String teamNameS) {
        pd.setTitle("Searching...");
        pd.show();
        fStore.collection(cmp+" AddReturnData").whereEqualTo("SearchTeamName",teamNameS.toLowerCase())
                .orderBy("Date", Query.Direction.DESCENDING)
                .get()
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    @Override
    ...
    private void searchDate(String cmp, String date) {
        ...
        pd.setTitle("Searching...");
        pd.show();
        fStore.collection(cmp+" AddReturnData").whereEqualTo("Date",date.toLowerCase())
                .get()
