...
public class SupervisorAddMaterial extends AppCompatActivity {
    ...
    String idS,dateS,teamNameS,lineS,tenderS,driverNameS,vehicalNameS,consumerNameS,siteNameS,materialReceiverNameS;
    ...
    LinearLayout updateError,verifyEmail;
    MaterialButton okGoIt,verifyBtn;
    ...
    SupervisorStockAdapter adapterStock;
    ...
    SupervisorKgToNoAdapter adapterStockKN;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_supervisor_add_material);
        ...
        mDateFormate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        SupervisorAddMaterial.this, R.style.DatePicker1,
        ...
        //LL
        updateError = findViewById(R.id.updateError);
        verifyEmail = findViewById(R.id.verifyEmail);
        okGoIt = findViewById(R.id.okGoIt);
        ...
        documentReference.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                layoutManager = new LinearLayoutManager(SupervisorAddMaterial.this);
                ...
                layoutManagerKN = new LinearLayoutManager(SupervisorAddMaterial.this);
                ...
                if (bundle!=null){
                    ...
                    if (formattedDate.equals(dateS)) {
                       showSetText();
                        ...
                        bar.hide();
                        okGoIt.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                ...
                adapterState = new ArrayAdapter<String>(SupervisorAddMaterial.this,R.layout.support_simple_spinner_dropdown_item,spinnerDataListState);
                ...
                adapterDistrict = new ArrayAdapter<String>(SupervisorAddMaterial.this,R.layout.support_simple_spinner_dropdown_item,spinnerDataListDistrict);
                ...
                adapterTaluka = new ArrayAdapter<String>(SupervisorAddMaterial.this,R.layout.support_simple_spinner_dropdown_item,spinnerDataListTaluka);
                ...
                adapter = new ArrayAdapter<String>(SupervisorAddMaterial.this,R.layout.support_simple_spinner_dropdown_item,spinnerDataList);
                ...
                adapterLine = new ArrayAdapter<String>(SupervisorAddMaterial.this,R.layout.support_simple_spinner_dropdown_item,spinnerDataListLine);
                ...
                adapterTender = new ArrayAdapter<String>(SupervisorAddMaterial.this,R.layout.support_simple_spinner_dropdown_item,spinnerDataListTender);
                ...
                adapterDriver = new ArrayAdapter<String>(SupervisorAddMaterial.this,R.layout.support_simple_spinner_dropdown_item,spinnerDataListDriver);
                ...
                adapterVehical = new ArrayAdapter<String>(SupervisorAddMaterial.this,R.layout.support_simple_spinner_dropdown_item,spinnerDataListVehical);
                ...
                adapterCenter = new ArrayAdapter<String>(SupervisorAddMaterial.this,R.layout.support_simple_spinner_dropdown_item,spinnerDataListCenter);
                ...
                adapterVillage = new ArrayAdapter<String>(SupervisorAddMaterial.this,R.layout.support_simple_spinner_dropdown_item,spinnerDataListVillage);
                ...
                adapterMaterial = new ArrayAdapter<String>(SupervisorAddMaterial.this,R.layout.support_simple_spinner_dropdown_item,spinnerDataListMaterial);
                ...
                adapterUnit = new ArrayAdapter<String>(SupervisorAddMaterial.this,R.layout.support_simple_spinner_dropdown_item,spinnerDataListUnit);
                ...
                adapterReceiver = new ArrayAdapter<String>(SupervisorAddMaterial.this,R.layout.support_simple_spinner_dropdown_item,spinnerDataListReceiver);
                ...
                verifyBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        else if (verifyCode.equals(randomNumber)){
                            showMessage("Match");
                            showSetText();
                            bar.show();
                ...
                forceUpdate.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        updateError.setVisibility(View.GONE);
    ...
    private void mail(String cmp, String name) {

        String message = "\n\nDate : "+dateS+"\nConsumer Name:"+consumerNameS
                            +"\nSite Name : "+siteNameS+"\nTeam Name:"+teamNameS
                            +"\nTender : "+tenderS+"\nLine:"+lineS
                            +"\n\nVarification Code is : "+randomNumber+". Don`t share the code"+"\n\nThanks you very much!!\n\n";
        
        JavaMailAPI javaMailAPI = new JavaMailAPI(this, cmp, name+" is updating following data", message);
        javaMailAPI.execute();
    }
    ...
    private void update(String cmp, String uDate, String uTeamName, String uLine, String uTender, String uDriverName, String uVehicalName, String uConsumerName, String uSite, String uMaterial1, String uQuantity1, String uMaterial2, String uQuantity2, String uMaterial3, String uQuantity3, String uMaterial4, String uQuantity4, String uMaterial5, String uQuantity5, String uMaterial6, String uQuantity6, String uMaterial7, String uQuantity7, String uMaterial8, String uQuantity8, String uMaterial9, String uQuantity9, String uMaterial10, String uQuantity10, String uQuantity11, String uMaterial12, String uQuantity12, String uMaterial13, String uQuantity13, String uMaterial14, String uQuantity14, String uMaterial15, String uQuantity15, String uMaterial16, String uQuantity16, String uMaterial17, String uQuantity17, String uMaterial18, String uQuantity18, String uMaterial19, String uQuantity19, String uMaterial20, String uQuantity20, String uUnit1, String uUnit2, String uUnit3, String uUnit4, String uUnit5, String uUnit6, String uUnit7, String uUnit8, String uUnit9, String uUnit10, String uUnit11, String uUnit12, String uUnit13, String uUnit14, String uUnit15, String uUnit16, String uUnit17, String uUnit18, String uUnit19, String uUnit20, String uMaterial11, String uMaterial21, String uQuantity21, String uMaterial22, String uQuantity22, String uMaterial23, String uQuantity23, String uMaterial24, String uQuantity24, String uMaterial25, String uQuantity25, String uMaterial26, String uQuantity26, String uMaterial27, String uQuantity27, String uMaterial28, String uQuantity28, String uMaterial29, String uQuantity29, String uMaterial30, String uQuantity30, String uUnit21, String uUnit22, String uUnit23, String uUnit24, String uUnit25, String uUnit26, String uUnit27, String uUnit28, String uUnit29, String uUnit30, String materialReceiver, String centerS, String villageS) {
        ...
        fStore.collection(cmp+" AddData").document(idS).update(
                "id", idS,
                "Date",uDate,
                "SearchDate",uDate.toLowerCase(),
                "Team Name",uTeamName,
                "SearchTeamName",uTeamName.toLowerCase(),
                "Line",uLine,
                "Tender",uTender,
                "SearchTender",uTender.toLowerCase(),
                "Driver Name",uDriverName,
                "Vehical Name",uVehicalName,
                "Consumer Name",uConsumerName,
                "Site Name",uSite,
                //Material
                "Material 1",uMaterial1,
                "Material 2",uMaterial2,
                "Material 3",uMaterial3,
                "Material 4",uMaterial4,
                "Material 5",uMaterial5,
                "Material 6",uMaterial6,
                "Material 7",uMaterial7,
                "Material 8",uMaterial8,
                "Material 9",uMaterial9,
                "Material 10",uMaterial10,
                "Material 11",uMaterial11,
                "Material 12",uMaterial12,
                "Material 13",uMaterial13,
                "Material 14",uMaterial14,
                "Material 15",uMaterial15,
                "Material 16",uMaterial16,
                "Material 17",uMaterial17,
                "Material 18",uMaterial18,
                "Material 19",uMaterial19,
                "Material 20",uMaterial20,
                "Material 21",uMaterial21,
                "Material 22",uMaterial22,
                "Material 23",uMaterial23,
                "Material 24",uMaterial24,
                "Material 25",uMaterial25,
                "Material 26",uMaterial26,
                "Material 27",uMaterial27,
                "Material 28",uMaterial28,
                "Material 29",uMaterial29,
                "Material 30",uMaterial30,
                //Quantity
                "Quantity 1",uQuantity1,
                "Quantity 2",uQuantity2,
                "Quantity 3",uQuantity3,
                "Quantity 4",uQuantity4,
                "Quantity 5",uQuantity5,
                "Quantity 6",uQuantity6,
                "Quantity 7",uQuantity7,
                "Quantity 8",uQuantity8,
                "Quantity 9",uQuantity9,
                "Quantity 10",uQuantity10,
                "Quantity 11",uQuantity11,
                "Quantity 12",uQuantity12,
                "Quantity 13",uQuantity13,
                "Quantity 14",uQuantity14,
                "Quantity 15",uQuantity15,
                "Quantity 16",uQuantity16,
                "Quantity 17",uQuantity17,
                "Quantity 18",uQuantity18,
                "Quantity 19",uQuantity19,
                "Quantity 20",uQuantity20,
                "Quantity 21",uQuantity21,
                "Quantity 22",uQuantity22,
                "Quantity 23",uQuantity23,
                "Quantity 24",uQuantity24,
                "Quantity 25",uQuantity25,
                "Quantity 26",uQuantity26,
                "Quantity 27",uQuantity27,
                "Quantity 28",uQuantity28,
                "Quantity 29",uQuantity29,
                "Quantity 30",uQuantity30,
                //Unit
                "Unit 1",uUnit1,
                "Unit 2",uUnit2,
                "Unit 3",uUnit3,
                ...
                "Unit 29",uUnit29,
                "Unit 30",uUnit30,
                "Material Receiver Name",materialReceiver,
                "Center",centerS,
                "Village",villageS,
                "SearchCenter",centerS.toLowerCase(),
                "SearchVillage",villageS.toLowerCase()
    ...
    private static String getRandomString(int a){
        final String ch = "ABCDEFGHIJKMNOPQRSTUVWXYZ1234567890";
    ...
    private void showData(String cmp) {
        fStore.collection(cmp+" AddStock").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                adapterStock = new SupervisorStockAdapter(SupervisorAddMaterial.this,modelList);
            ...
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                Toast.makeText(SupervisorAddMaterial.this, "Failed "+e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void showDataKN(String cmp) {
        fStore.collection(cmp+" KgToNo").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                adapterStockKN = new SupervisorKgToNoAdapter(SupervisorAddMaterial.this,modelListKN);
