...
public class AdminReturnViewHolder extends RecyclerView.ViewHolder{
    TextView mDate,mTeamName,mTender,mConsumerName,mSiteName,mCenter;
    View mView;

    public AdminReturnViewHolder(@NonNull View itemView) {
        super(itemView);
        mView = itemView;
    ...
    private AdminReturnViewHolder.ClickListener mClickListener;
    public interface ClickListener{
        void onItemClick(View view,int position);
        void onItemLongClick(View view,int position);
    }

    public void setOnClickListener(AdminReturnViewHolder.ClickListener clickListener){
