...
public class AdminViewKgToNoAdapter extends RecyclerView.Adapter<KgToNoViewHolder> {
    AdminViewMaterial addStock;
    List<KgToNoModel> modelList;

    public AdminViewKgToNoAdapter(AdminViewMaterial addStock, List<KgToNoModel> modelList) {
