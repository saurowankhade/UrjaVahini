...
public class SupervisorReturnViewHolder extends RecyclerView.ViewHolder{
    TextView mDate,mTeamName,mTender,mConsumerName,mSiteName,mCenter;
    View mView;

    public SupervisorReturnViewHolder(@NonNull View itemView) {
        super(itemView);
        mView = itemView;
    ...
    private SupervisorReturnViewHolder.ClickListener mClickListener;
    public interface ClickListener{
        void onItemClick(View view,int position);
        void onItemLongClick(View view,int position);
    }

    public void setOnClickListener(SupervisorReturnViewHolder.ClickListener clickListener){
