...
public class RemainingMaterialCustomAdapter extends RecyclerView.Adapter<RemainingMaterialViewHolder>{

    RemainingMaterial adminViewMaterial;
    List<ReaminingMaterialModel> modelList;

    public RemainingMaterialCustomAdapter(RemainingMaterial adminViewMaterial, List<ReaminingMaterialModel> modelList) {
