...
public class AdminReturnKgToNoAdapter extends RecyclerView.Adapter<KgToNoViewHolder> {
    AddReturnMaterial addStock;
    List<KgToNoModel> modelList;

    public AdminReturnKgToNoAdapter(AddReturnMaterial addStock, List<KgToNoModel> modelList) {
